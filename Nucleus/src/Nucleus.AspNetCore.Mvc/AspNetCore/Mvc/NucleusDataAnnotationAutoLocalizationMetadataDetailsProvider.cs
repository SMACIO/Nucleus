...
{
    public class NucleusDataAnnotationAutoLocalizationMetadataDetailsProvider : IDisplayMetadataProvider
    {
        ...
        public NucleusDataAnnotationAutoLocalizationMetadataDetailsProvider(IServiceCollection services)
        {
