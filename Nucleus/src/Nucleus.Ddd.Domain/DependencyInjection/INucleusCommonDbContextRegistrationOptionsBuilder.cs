...
{
    public interface INucleusCommonDbContextRegistrationOptionsBuilder
    {
        ...
        /// </param>
        INucleusCommonDbContextRegistrationOptionsBuilder AddDefaultRepositories(bool includeAllEntities = false);
        ...
        /// </param>
        INucleusCommonDbContextRegistrationOptionsBuilder AddDefaultRepositories<TDefaultRepositoryDbContext>(bool includeAllEntities = false);
        ...
        /// Set <see cref="includeAllEntities"/> to true to include all entities.
        /// </param>
        INucleusCommonDbContextRegistrationOptionsBuilder AddDefaultRepositories(Type defaultRepositoryDbContextType, bool includeAllEntities = false);

        /// <summary>
        /// Registers default repository for a specific entity.
        /// </summary>
        /// <typeparam name="TEntity">Entity type</typeparam>
        INucleusCommonDbContextRegistrationOptionsBuilder AddDefaultRepository<TEntity>();
        ...
        /// <returns></returns>
        INucleusCommonDbContextRegistrationOptionsBuilder AddDefaultRepository(Type entityType);
        ...
        INucleusCommonDbContextRegistrationOptionsBuilder AddRepository<TEntity, TRepository>();
        ...
        /// <returns></returns>
        INucleusCommonDbContextRegistrationOptionsBuilder SetDefaultRepositoryClasses([NotNull] Type repositoryImplementationType, [NotNull] Type repositoryImplementationTypeWithoutKey);
        ...
        INucleusCommonDbContextRegistrationOptionsBuilder ReplaceDbContext<TOtherDbContext>();
        ...
        INucleusCommonDbContextRegistrationOptionsBuilder ReplaceDbContext<TOtherDbContext, TTargetDbContext>();
        ...
        INucleusCommonDbContextRegistrationOptionsBuilder ReplaceDbContext(Type otherDbContextType, Type targetDbContextType = null);
    }
}
