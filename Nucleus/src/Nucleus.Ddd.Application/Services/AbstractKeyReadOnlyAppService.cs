...
namespace Nucleus.Application.Services
{
        ...
        where TEntity : class, IEntity
    {
        ...
        protected virtual IQueryable<TEntity> ApplyDefaultSorting(IQueryable<TEntity> query)
        {
            ...
            throw new NucleusException("No sorting specified but this query requires sorting. Override the ApplyDefaultSorting method for your application service derived from AbstractKeyReadOnlyAppService!");
        }
