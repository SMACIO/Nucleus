...
namespace Nucleus.Users
{
    public static class CurrentUserExtensions
    {
        ...
        {
            var impersonatorTenantId = currentUser.FindClaimValue(NucleusClaimTypes.ImpersonatorTenantId);
        ...
        {
            var impersonatorUserId = currentUser.FindClaimValue(NucleusClaimTypes.ImpersonatorUserId);
