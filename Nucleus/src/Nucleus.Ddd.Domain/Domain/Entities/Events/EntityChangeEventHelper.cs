...
namespace Nucleus.Domain.Entities.Events
{
    /// <summary>
    ...
    {
        private const string UnitOfWorkEventRecordEntityPropName = "_Nucleus_Entity";
        ...
        protected NucleusDistributedEntityEventOptions DistributedEntityEventOptions { get; }

        public EntityChangeEventHelper(
            IUnitOfWorkManager unitOfWorkManager,
            IEntityToEtoMapper entityToEtoMapper,
            IOptions<NucleusDistributedEntityEventOptions> distributedEntityEventOptions)
        {
