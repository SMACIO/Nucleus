...
{
    public class NucleusLazyServiceProvider : INucleusLazyServiceProvider, ITransientDependency
    {
        protected IDictionary<Type, object> CachedServices { get; set; }

        protected IServiceProvider ServiceProvider { get; set; }

        public NucleusLazyServiceProvider(IServiceProvider serviceProvider)
        {
