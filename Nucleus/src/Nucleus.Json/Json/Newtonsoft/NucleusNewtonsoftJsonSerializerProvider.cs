...
{
    public class NucleusNewtonsoftJsonSerializerProvider : IJsonSerializerProvider, ITransientDependency
    {
        ...
        public NucleusNewtonsoftJsonSerializerProvider(
            IOptions<NucleusNewtonsoftJsonSerializerOptions> options,
