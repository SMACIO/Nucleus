...
namespace Nucleus.Aspects
{
    public static class NucleusCrossCuttingConcerns
    {
        //TODO: Move these constants to their own assemblies!

        public const string Auditing = "NucleusAuditing";
        public const string UnitOfWork = "NucleusUnitOfWork";
        public const string FeatureChecking = "NucleusFeatureChecking";
        public const string GlobalFeatureChecking = "NucleusGlobalFeatureChecking";
