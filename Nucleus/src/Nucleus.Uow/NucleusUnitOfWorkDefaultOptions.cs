...
namespace Nucleus.Uow
{
    ...
    /// </summary>
    public class NucleusUnitOfWorkDefaultOptions
    {
        /// <summary>
        ...
        internal NucleusUnitOfWorkOptions Normalize(NucleusUnitOfWorkOptions options)
        {
        ...
        public bool CalculateIsTransactional(bool autoValue)
        {
            switch (TransactionBehavior)
            {
                ...
                case UnitOfWorkTransactionBehavior.Auto:
                    return autoValue;
                default:
                    throw new NucleusException("Not implemented TransactionBehavior value: " + TransactionBehavior);
            }
        }
    }
}
