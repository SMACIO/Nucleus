...
{
    //TODO: Move to Nucleus.Data.ObjectExtending namespace at v3.0
    ...
    public static class HasExtraPropertiesExtensions
    {
        ...
        public static TProperty GetProperty<TProperty>(this IHasExtraProperties source, string name, TProperty defaultValue = default)
        {
            ...
            throw new NucleusException("GetProperty<TProperty> does not support non-primitive types. Use non-generic GetProperty method and handle type casting manually.");
        }
