...
namespace Nucleus.AspNetCore.Mvc.AntiForgery
{
    ...
    public class NucleusAutoValidateAntiforgeryTokenAttribute : Attribute, IFilterFactory, IOrderedFilter
    {
        /// <summary>
        ...
        {
            return serviceProvider.GetRequiredService<NucleusAutoValidateAntiforgeryTokenAuthorizationFilter>();
        }
    }
}
