...
namespace Nucleus.Caching
{
        ...
        where TCacheItem : class
    {
        public DistributedCache(
            IOptions<NucleusDistributedCacheOptions> distributedCacheOption,
    ...
    public class DistributedCache<TCacheItem, TCacheKey> : IDistributedCache<TCacheItem, TCacheKey>
        where TCacheItem : class
    {
        public const string UowCacheName = "NucleusDistributedCache";
        ...
        private readonly NucleusDistributedCacheOptions _distributedCacheOption;
        ...
        protected virtual KeyValuePair<TCacheKey, TCacheItem>[] ToCacheItems(byte[][] itemBytes, TCacheKey[] itemKeys)
        {
            ...
            {
                throw new NucleusException("count of the item bytes should be same with the count of the given keys");
            }
        ...
        protected virtual Dictionary<TCacheKey, UnitOfWorkCacheItem<TCacheItem>> GetUnitOfWorkCache()
        {
            ...
            {
                throw new NucleusException($"There is no active UOW.");
            }
