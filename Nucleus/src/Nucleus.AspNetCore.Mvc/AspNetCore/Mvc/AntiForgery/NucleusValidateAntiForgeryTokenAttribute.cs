...
namespace Nucleus.AspNetCore.Mvc.AntiForgery
{
    ...
    public class NucleusValidateAntiForgeryTokenAttribute : Attribute, IFilterFactory, IOrderedFilter
    {
        /// <summary>
        ...
        {
            return serviceProvider.GetRequiredService<NucleusValidateAntiforgeryTokenAuthorizationFilter>();
        }
    }
}
