...
{
    public class NucleusDateTimeModelBinderProvider : IModelBinderProvider
    {
        public IModelBinder GetBinder(ModelBinderProviderContext context)
        {
            ...
            if (modelType == typeof(DateTime))
            {
                if (context.Metadata.ContainerType == null)
                {
                    ...
                    {
                        return CreateNucleusDateTimeModelBinder(context);
                    }
                }
                else
                {
        ...
        protected virtual NucleusDateTimeModelBinder CreateNucleusDateTimeModelBinder(ModelBinderProviderContext context)
        {
            ...
            return new NucleusDateTimeModelBinder(context.Services.GetRequiredService<IClock>(), dateTimeModelBinder);
        }
    }
}
