...
namespace Nucleus.Http.Client.DynamicProxying
{
    public class ApiDescriptionFinder : IApiDescriptionFinder, ITransientDependency
    {
        ...
        protected NucleusCorrelationIdOptions NucleusCorrelationIdOptions { get; }
        protected ICorrelationIdProvider CorrelationIdProvider { get; }
        protected ICurrentTenant CurrentTenant { get; }

        public ApiDescriptionFinder(
            IApiDescriptionCache cache,
            IOptions<NucleusCorrelationIdOptions> nucleusCorrelationIdOptions,
            ICorrelationIdProvider correlationIdProvider,
            ICurrentTenant currentTenant)
        {
            Cache = cache;
            NucleusCorrelationIdOptions = nucleusCorrelationIdOptions.Value;
            ...
            MethodInfo method)
        {
            ...
            throw new NucleusException($"Could not found remote action for method: {method} on the URL: {baseUrl}");
        }
            ...
            string baseUrl)
        {
            var requestMessage = new HttpRequestMessage(
                HttpMethod.Get,
                baseUrl.EnsureEndsWith('/') + "api/nucleus/api-definition"
            );
            ...
            {
                throw new NucleusException("Remote service returns error! StatusCode = " + response.StatusCode);
            }
        ...
        {
            //CorrelationId
            requestMessage.Headers.Add(NucleusCorrelationIdOptions.HttpHeaderName, CorrelationIdProvider.Get());
