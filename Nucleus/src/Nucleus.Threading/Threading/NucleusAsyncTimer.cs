...
namespace Nucleus.Threading
{
    ...
    /// </summary>
    public class NucleusAsyncTimer : ITransientDependency
    {
        /// <summary>
        /// This func is raised periodically according to Period of Timer.
        /// </summary>
        public Func<NucleusAsyncTimer, Task> Elapsed = _ => Task.CompletedTask;
        ...
        public ILogger<NucleusAsyncTimer> Logger { get; set; }
        ...
        public NucleusAsyncTimer()
        {
            ExceptionNotifier = NullExceptionNotifier.Instance;
            Logger = NullLogger<NucleusAsyncTimer>.Instance;
        ...
        public void Start(CancellationToken cancellationToken = default)
        {
            if (Period <= 0)
            {
                throw new NucleusException("Period should be set before starting the timer!");
            }
