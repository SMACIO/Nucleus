...
{
    public class NucleusValidateAntiforgeryTokenAuthorizationFilter : IAsyncAuthorizationFilter, IAntiforgeryPolicy, ITransientDependency
    {
        private IAntiforgery _antiforgery;
        private readonly NucleusAntiForgeryCookieNameProvider _antiForgeryCookieNameProvider;
        private readonly ILogger<NucleusValidateAntiforgeryTokenAuthorizationFilter> _logger;

        public NucleusValidateAntiforgeryTokenAuthorizationFilter(
