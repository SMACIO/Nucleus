...
namespace Nucleus.Auditing
{
    ...
    {
        private const string AmbientContextKey = "Nucleus.Auditing.IAuditLogScope";

        protected IServiceProvider ServiceProvider { get; }
        protected NucleusAuditingOptions Options { get; }
        ...
        public AuditingManager(
            ...
            IOptions<NucleusAuditingOptions> options)
        {
