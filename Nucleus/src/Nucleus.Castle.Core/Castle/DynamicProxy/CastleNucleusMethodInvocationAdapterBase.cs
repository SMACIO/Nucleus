...
{
    public abstract class CastleNucleusMethodInvocationAdapterBase : INucleusMethodInvocation
    {
        ...
        protected CastleNucleusMethodInvocationAdapterBase(IInvocation invocation)
        {
