...
using Nucleus.AspNetCore.Mvc.Utils;
...
namespace Nucleus.AspNetCore.Mvc
{
    public class AspNetCoreApiDescriptionModelProvider : IApiDescriptionModelProvider, ITransientDependency
    {
        ...
        private readonly NucleusAspNetCoreMvcOptions _nucleusAspNetCoreMvcOptions;
        private readonly NucleusApiDescriptionModelOptions _modelOptions;

        public AspNetCoreApiDescriptionModelProvider(
            IOptions<AspNetCoreApiDescriptionModelProviderOptions> options,
            IApiDescriptionGroupCollectionProvider descriptionProvider,
            IOptions<NucleusAspNetCoreMvcOptions> nucleusAspNetCoreMvcOptions,
            IOptions<NucleusApiDescriptionModelOptions> modelOptions)
        {
            _options = options.Value;
            _descriptionProvider = descriptionProvider;
            _nucleusAspNetCoreMvcOptions = nucleusAspNetCoreMvcOptions.Value;
        ...
        {
            foreach (var controllerSetting in _nucleusAspNetCoreMvcOptions.ConventionalControllers.ConventionalControllerSettings)
            {
