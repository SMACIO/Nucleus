...
namespace Nucleus.Localization.Json
{
    public static class JsonLocalizationDictionaryBuilder
    {
        ...
        public static ILocalizationDictionary BuildFromFile(string filePath)
        {
            ...
            {
                throw new NucleusException("Invalid localization file format: " + filePath, ex);
            }
        }
        ...
        public static ILocalizationDictionary BuildFromJsonString(string jsonString)
        {
            ...
            {
                throw new NucleusException("Can not parse json string. " + ex.Message);
            }

            var cultureCode = jsonFile.Culture;
            if (string.IsNullOrEmpty(cultureCode))
            {
                throw new NucleusException("Culture is empty in language json file.");
            }
            ...
            foreach (var item in jsonFile.Texts)
            {
                ...
                {
                    throw new NucleusException("The key is empty in given json string.");
                }
