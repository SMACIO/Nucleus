...
namespace Nucleus.Validation
{
    public class ObjectValidator : IObjectValidator, ITransientDependency
    {
        ...
        protected NucleusValidationOptions Options { get; }

        public ObjectValidator(IOptions<NucleusValidationOptions> options, IServiceScopeFactory serviceScopeFactory)
        {
