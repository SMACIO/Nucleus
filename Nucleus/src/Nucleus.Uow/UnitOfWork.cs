...
namespace Nucleus.Uow
{
    public class UnitOfWork : IUnitOfWork, ITransientDependency
    {
        ...
        public const string UnitOfWorkReservationName = "_NucleusActionUnitOfWork";

        public Guid Id { get; } = Guid.NewGuid();

        public INucleusUnitOfWorkOptions Options { get; private set; }
        ...
        private readonly NucleusUnitOfWorkDefaultOptions _defaultOptions;
        ...
        public UnitOfWork(
            ...
            IOptions<NucleusUnitOfWorkDefaultOptions> options)
        {
        ...
        public virtual void Initialize(NucleusUnitOfWorkOptions options)
        {
            Check.NotNull(options, nameof(options));

            if (Options != null)
            {
                throw new NucleusException("This unit of work is already initialized before!");
            }
        ...
        public virtual void AddDatabaseApi(string key, IDatabaseApi api)
        {
            ...
            {
                throw new NucleusException("There is already a database API in this unit of work with given key: " + key);
            }
        ...
        public virtual void AddTransactionApi(string key, ITransactionApi api)
        {
            ...
            {
                throw new NucleusException("There is already a transaction API in this unit of work with given key: " + key);
            }
        ...
        private void PreventMultipleComplete()
        {
            ...
            {
                throw new NucleusException("Complete is called before!");
            }
        }
