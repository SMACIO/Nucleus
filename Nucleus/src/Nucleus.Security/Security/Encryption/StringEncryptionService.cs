...
namespace Nucleus.Security.Encryption
{
    /// <summary>
    ...
    {
        protected NucleusStringEncryptionOptions Options { get; }

        public StringEncryptionService(IOptions<NucleusStringEncryptionOptions> options)
        {
