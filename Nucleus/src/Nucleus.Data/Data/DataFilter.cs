...
{
    //TODO: Create a Nucleus.Data.Filtering namespace?
        ...
        where TFilter : class
    {
        ...
        private readonly NucleusDataFilterOptions _options;

        private readonly AsyncLocal<DataFilterState> _filter;

        public DataFilter(IOptions<NucleusDataFilterOptions> options)
        {
