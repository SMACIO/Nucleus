...
namespace Nucleus.Caching.StackExchangeRedis
{
    ...
    public class NucleusRedisCache : RedisCache, ICacheSupportsMultipleItems
    {
        ...
        public NucleusRedisCache(IOptions<RedisCacheOptions> optionsAccessor)
