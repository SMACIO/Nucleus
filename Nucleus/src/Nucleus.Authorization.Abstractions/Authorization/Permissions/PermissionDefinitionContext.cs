...
namespace Nucleus.Authorization.Permissions
{
    public class PermissionDefinitionContext : IPermissionDefinitionContext
    {
            ...
            MultiTenancySides multiTenancySide = MultiTenancySides.Both)
        {
            ...
            {
                throw new NucleusException($"There is already an existing permission group with name: {name}");
            }
        ...
        public virtual PermissionGroupDefinition GetGroup([NotNull] string name)
        {
            ...
            if (group == null)
            {
                throw new NucleusException($"Could not find a permission definition group with the given name: {name}");
            }
        ...
        public virtual void RemoveGroup(string name)
        {
            ...
            if (!Groups.ContainsKey(name))
            {
                throw new NucleusException($"Not found permission group with name: {name}");
            }
