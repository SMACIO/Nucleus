...
namespace Nucleus.Authorization
{
    public class MethodInvocationAuthorizationService : IMethodInvocationAuthorizationService, ITransientDependency
    {
        ...
        private readonly INucleusAuthorizationService _nucleusAuthorizationService;

        public MethodInvocationAuthorizationService(
            INucleusAuthorizationPolicyProvider nucleusAuthorizationPolicyProvider,
            INucleusAuthorizationService nucleusAuthorizationService)
        {
            _nucleusAuthorizationPolicyProvider = nucleusAuthorizationPolicyProvider;
            _nucleusAuthorizationService = nucleusAuthorizationService;
        }
        ...
        public async Task CheckAsync(MethodInvocationAuthorizationContext context)
        {
            ...
            var authorizationPolicy = await AuthorizationPolicy.CombineAsync(
                _nucleusAuthorizationPolicyProvider,
            ...
            await _nucleusAuthorizationService.CheckAsync(authorizationPolicy);
        }
