...
{
    public class NucleusDictionaryBasedStringLocalizer : IStringLocalizer, IStringLocalizerSupportsInheritance
    {
        ...
        public NucleusDictionaryBasedStringLocalizer(LocalizationResource resource, List<IStringLocalizer> baseLocalizers)
        {
            Resource = resource;
        ...
        public class CultureWrapperStringLocalizer : IStringLocalizer, IStringLocalizerSupportsInheritance
        {
            ...
            private readonly NucleusDictionaryBasedStringLocalizer _innerLocalizer;
            ...
            public CultureWrapperStringLocalizer(string cultureName, NucleusDictionaryBasedStringLocalizer innerLocalizer)
            {
