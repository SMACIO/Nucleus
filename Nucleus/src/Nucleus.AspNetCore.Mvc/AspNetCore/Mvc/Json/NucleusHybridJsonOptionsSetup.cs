...
{
    public class NucleusHybridJsonOptionsSetup : IConfigureOptions<MvcOptions>
    {
        ...
        public NucleusHybridJsonOptionsSetup(
        ...
        public void Configure(MvcOptions options)
        {
            ...
            options.InputFormatters.Add(new NucleusHybridJsonInputFormatter(systemTextJsonInputFormatter, newtonsoftJsonInputFormatter));
            ...
            options.OutputFormatters.Add(new NucleusHybridJsonOutputFormatter(systemTextJsonOutputFormatter, newtonsoftJsonOutputFormatter));
        }
    }
}
