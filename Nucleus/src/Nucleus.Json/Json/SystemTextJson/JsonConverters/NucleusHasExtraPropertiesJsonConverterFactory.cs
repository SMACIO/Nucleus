...
{
    public class NucleusHasExtraPropertiesJsonConverterFactory : JsonConverterFactory
    {
        ...
        public virtual NucleusHasExtraPropertiesJsonConverterFactory AddExcludeTypes(params Type[] excludeTypes)
        {
        ...
        public override JsonConverter CreateConverter(Type typeToConvert, JsonSerializerOptions options)
        {
            return (JsonConverter) Activator.CreateInstance(
                typeof(NucleusHasExtraPropertiesJsonConverter<>).MakeGenericType(typeToConvert),
