...
namespace Nucleus.Features
{
    public class FeatureDefinitionManager : IFeatureDefinitionManager, ISingletonDependency
    {
        ...
        protected NucleusFeatureOptions Options { get; }

        private readonly IServiceScopeFactory _serviceScopeFactory;

        public FeatureDefinitionManager(
            IOptions<NucleusFeatureOptions> options,
        ...
        public virtual FeatureDefinition Get(string name)
        {
            ...
            if (feature == null)
            {
                throw new NucleusException("Undefined feature: " + name);
            }
            ...
            FeatureDefinition feature)
        {
            ...
            {
                throw new NucleusException("Duplicate feature name: " + feature.Name);
            }
