...
{
    public class NucleusNullableDateTimeConverter : JsonConverter<DateTime?>, ITransientDependency
    {
        private readonly IClock _clock;
        private readonly NucleusJsonOptions _options;

        public NucleusNullableDateTimeConverter(IClock clock, IOptions<NucleusJsonOptions> nucleusJsonOptions)
        {
            _clock = clock;
