...
{
    public class NucleusExtraPropertiesDictionaryModelBinderProvider : IModelBinderProvider
    {
        public IModelBinder GetBinder(ModelBinderProviderContext context)
        {
            ...
            var valueBinder = new NucleusExtraPropertyModelBinder(context.Metadata.ContainerType);
