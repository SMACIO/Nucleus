...
namespace Nucleus.MultiTenancy
{
    public class TenantResolver : ITenantResolver, ITransientDependency
    {
        ...
        private readonly NucleusTenantResolveOptions _options;

        public TenantResolver(IOptions<NucleusTenantResolveOptions> options, IServiceProvider serviceProvider)
        {
