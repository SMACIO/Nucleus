...
{
    //TODO: Instead of directly using static properties, can we just create an NucleusClaimOptions and pass these values as defaults?
    /// <summary>
    /// Used to get Nucleus-specific claim type names.
    /// </summary>
    public static class NucleusClaimTypes
    {
        /// <summary>
