...
namespace Nucleus.SimpleStateChecking
{
        ...
        where TState : IHasSimpleStateCheckers<TState>
    {
        ...
        protected NucleusSimpleStateCheckerOptions<TState> Options { get; }

        public SimpleStateCheckerManager(IServiceProvider serviceProvider, IOptions<NucleusSimpleStateCheckerOptions<TState>> options)
        {
